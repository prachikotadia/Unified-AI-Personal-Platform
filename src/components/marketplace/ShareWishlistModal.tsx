...
import { X, Copy, Mail, MessageCircle, Link2, CheckCircle } from 'lucide-react';
...
const ShareWishlistModal: React.FC<ShareWishlistModalProps> = ({
  ...
  const shareUrl = `${window.location.origin}/marketplace/wishlist/${wishlistId || 'shared'}`;
          ...
          {wishlistName && (
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
              <p className="text-sm text-blue-800 dark:text-blue-200">
                <strong>Wishlist:</strong> {wishlistName}
              </p>
            </div>
          )}
